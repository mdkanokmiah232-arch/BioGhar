...
export const biodatas: Biodata[] = [
  ...
  },
  {
    ...
    bloodGroup: "B+",
    nationality: "বাংলাদেশী",
    presentAddress: { district: "রাজশাহী", division: "রাজশাহী", area: "রাজশাহী শহর" },
    permanentAddress: { district: "রাজশাহী", division: "রাজশাহী", area: "রাজশাহী" },
    grownUpIn: "রাজশাহী",
    religion: "ইসলাম",
    madhab: "হানাফি",
    prayerRegularity: "নিয়মিত",
    hijabOrBeard: "বোরকা, হিজাব, নিকাব, হাত মোজা, পা মোজা",
    quranRecitation: "হ্যা, আলহামদুলিল্লাহ। কুরআন পড়ার চেষ্টা করি।",
    religiousQualification: "দ্বীনের ফরজ জ্ঞান আছে",
    educationMedium: "জেনারেল",
    educationLevel: "স্নাতক (সম্মান)",
    ...
    motherAlive: true,
    brothers: 1,
    brothersInfo: "ছোট ভাই কলেজে পড়ছে।",
    sisters: 2,
    sistersInfo: "বড় বোন: বিবাহিত। ছোট বোন: স্কুলে পড়ছে।",
    uncleProfessions: "চাচা-ব্যবসায়ী, মামা-সরকারি চাকুরিজীবী।",
    familyReligiousEnvironment: "পরিবারে দ্বীনী পরিবেশ মোটামুটি আছে। নামাজ কুরআন পড়া হয়। পর্দার ব্যাপারে সহনশীল।",
    familyFinancialCondition: "মধ্যবিত্ত",
    familyHousing: "নিজস্ব বাসা, দোতলা।",
    familyLand: "গ্রামে কিছু জমি আছে।",
    personalClothing: "বোরকা, হিজাব, নিকাব, হাত মোজা, পা মোজা",
    personalNikab: "২ বছর ধরে আলহামদুলিল্লাহ।",
    personalNamazDetail: "নিয়মিত পড়ি আলহামদুলিল্লাহ।",
    personalNamazWeekly: "নায়ফ ছাড়া বাকি সব নামাজ পড়ি।",
    personalMahram: "হ্যা, আলহামদুলিল্লাহ।",
    personalQuranRecite: "হ্যা, আলহামদুলিল্লাহ।",
    personalFiqh: "হানাফি",
    personalEntertainment: "বই পড়া, হাইকিং।",
    personalHealth: "নাই, আলহামদুলিল্লাহ।",
    personalDawahWork: "কুরআন শিখানোর চেষ্টা করি।",
    personalMazarBelief: "মাজার জিয়ারতে কোন কিছু চাওয়া শিরক। তবে গিয়ে দোয়া করা জায়েজ।",
    personalBooksRead: "ইসলামি জীবনব্যবস্থা, দ্বীনে ফেরার পর।",
    personalFavScholars: "জাকির নায়েক, মাওলানা তাকী উসমান।",
    personalHobbies: "বই পড়া, প্রকৃতি ভালোবাসি, কুকুর পালা পছন্দ করি। সাদাসিধে জীবনযাপন পছন্দ করি।",
    professionDetail: "পড়াশোনা করছি।",
    marriageGuardianConsent: "হ্যা, আলহামদুলিল্লাহ।",
    marriageJobAfter: "পারমিশন থাকলে করব।",
    marriageStudyAfter: "জ্বি, পড়াশোনা চালিয়ে যেতে চাই।",
    marriageWhy: "অর্ধেক দ্বীন পূরন করতে। নেককার জীবনসঙ্গী পেতে।",
    partnerPreferences: {
      ageRange: "২৫-৩২",
      height: "৫.৬ বা এর বেশি",
      complexion: "শ্যামলা, ফর্সা",
      education: "স্নাতক বা তার সমমান",
      location: "রাজশাহী, সকল",
      maritalStatus: "অবিবাহিত",
      profession: "হালাল উপার্জন থাকতে হবে। চাকরি বা ব্যবসা।",
      economicStatus: "সচ্ছল, মধ্যবিত্ত",
      qualities: "দ্বীনদার, চরিত্রবান, পাঁচ ওয়াক্ত নামাজী, হালাল উপার্জনকারী, দানশীল, নজরের হেফাজতকারী।",
    },
    commitment1: "হ্যাঁ",
    commitment2: "হ্যাঁ",
    commitment3: "হ্যাঁ",
