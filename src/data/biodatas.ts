...
export const biodatas: Biodata[] = [
  ...
  },
  {
    ...
    bloodGroup: "O+",
    nationality: "বাংলাদেশী",
    presentAddress: { district: "রাজশাহী", division: "রাজশাহী", area: "নওহাটা বড়গাছী" },
    permanentAddress: { district: "রাজশাহী", division: "রাজশাহী", area: "নওহাটা বড়গাছী" },
    grownUpIn: "গ্রামে",
    religion: "ইসলাম",
    madhab: "আহলে হাদীস / সালাফি",
    prayerRegularity: "নিয়মিত",
    hijabOrBeard: "বোরকা, হিজাব ও নিকাব",
    quranRecitation: "জ্বি আলহামদুলিল্লাহ",
    religiousQualification: "দাখিল ও আলিম পাস",
    educationMedium: "আলিয়া",
    educationLevel: "B.Sc Nursing",
    ...
    personalClothing: "বোরকা, হিজাব ও নিকাব",
