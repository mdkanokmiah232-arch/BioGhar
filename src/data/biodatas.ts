...
export const districts = ['Dhaka','Chittagong','Sylhet','Rajshahi','Khulna','Barishal','Rangpur','Mymensingh','Comilla','Bogra','Cox\'s Bazar','Gazipur'  {
    ...
    partnerPreferences: {
      ...
      profession: "হালাল ভালো চাকরি (ব্যাংক এবং পুলিশ ব্যতীত)",
      economicStatus: "সচ্ছল, মানানসই",
      qualities: "দ্বীনদার, চরিত্রবান, তাকওয়াবান, উত্তম আখলাকের অধিকারী। ৫ ওয়াক্ত নামাজী, হালাল উপার্জনকারী, দানশীল, দ্বীনি জ্ঞান থাকতে হবে। আর অবশ্যই অবশ্যই নজরের হেফাজতকারী। লেবাসধারী নয়, অন্তরে দ্বীন থাকতে হবে। আমাকে আমার দ্বীনদারিতায় সম্পূর্ণ সাপোর্ট করবে। বাসায় পর্দার পরিবেশ থাকতে হবে। আমি যেহেতু সম্পূর্ণ, নন মাহরাম মেইনটেইন করি, অবশ্যই এই বিষয়ে সাপোর্ট করতে হবে। স্বভাবে খুব বেশি রাগী/বদমেজাজী, মিথ্যা বলার অভ্যাস, অশ্লীল ভাষাকারী, দানশীল নয়, কৃপন, অহংকারী, দাম্ভিক এরকম একদমই নয়।",
    },
    commitment1: "হ্যাঁ",
    commitment2: "হ্যাঁ",
    commitment3: "হ্যাঁ",
