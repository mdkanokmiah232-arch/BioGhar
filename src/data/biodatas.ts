...
export const biodatas: Biodata[] = [
  ...
  },
  {
    ...
    religiousQualification: "ইসলামিক অনলাইন মাদরাসায় (IOM) এ আলিম কোর্স চলমান। ২য় সেমিস্টার শেষ করেছি, আলহামদুলিল্লাহ। ৩য় সেমিস্টার চলমান। Batch -2514। রুকইয়া কোর্স চলমান। সূরা আল-মূলক হিফজকরন কোর্স করেছি, আলহামদুলিল্লাহ।",
    educationMedium: "জেনারেল",
    educationLevel: "স্নাতক ১ম বর্ষ ফাইনাল এক্সাম দিয়েছি",
    ...
    fatherAlive: false,
    motherName: "বেগম সাবরিনা",
    motherOccupation: "গৃহিণী",
    motherAlive: true,
    brothers: 1,
    brothersInfo: "বড় ভাই বিবাহিত, একটা ছেলে আছে। গ্রামে শিক্ষকতা করেন।",
    sisters: 1,
    sistersInfo: "বড় বোন: বিবাহিত। পড়াশোনা; honors complete। স্বামী: ইতালি প্রবাসী। আমার বোন IELTS করতাছে। ২-৩ বছরের মধ্যে স্টুডেন্ট ভিসাই ইতালি চলে যাওয়ার চেষ্টা করতেছেন, ইন শা আল্লাহ। আপাতত UNDP তে একটা জব করতেছে। আমার বড় বোনের ইনকামেই আমাদের খরচ চলে, আলহামদুলিল্লাহ।",
    ...
    familyLand: "মধ্যবিত্ত, আলহামদুলিল্লাহ। গ্রামের বাড়িতে তিন রুমের পাকা করা বাড়ি আছে। আর কিছু জমি আছে। আলহামদুলিল্লাহ।",
    ...
    personalHobbies: "আল্লাহর হুকুম-আহকাম ও ইসলামি রিতী-নীতি মেনে জীবনযাপন করতে চাই। প্রচুর ইসলামিক জ্ঞান অর্জন করার ইচ্ছা। সাধাসিধে জিবনযাবন পছন্দ করি। পরিষ্কার-পরিচ্ছন্নতা পছন্দ করি। দুনিয়াবি বিষয়ে যতটুকু প্রয়োজন ততটুকু সন্তুষ্ট থাকার চেষ্টা করি, আলহামদুলিল্লাহ। সর্বোপরি, মহান আল্লাহ তা'য়ালার সন্তুষ্টি অর্জন করায় আমার জীবনের লক্ষ্য। আমার ইচ্ছে-অনেক অনেক ইসলামিক জ্ঞান অর্জন করা, যা দ্বারা আমি আল্লাহর সন্তুষ্টি অর্জন করতে পারবো এবং আমার ও আল্লাহর সৃষ্টির উপকার করতে পারবো, ইনশা-আল্লাহ। মানুষকে উপকার ও সাহায্য করতে ভালোবাসি। হিংসা, অহংকার, রাগ, মিথ্যা বলা পছন্দ করি না। চেঁচামেচি ও উচ্চস্বরে কথা বলে রাগারাগি করা একদম পছন্দ করি না। অহংকারী মানুষ একদম পছন্দ না। আমার স্বপ্ন -এই ক্ষণস্থায়ী দুনিয়ায় পরিপূর্ণভাবে আল্লাহর সন্তুষ্টি অর্জন করে, আখিরাতে চিরস্থায়ী জান্নাত লাভ করা, ইনশা-আল্লাহ। হজ্জে যাওয়ার ইচ্ছে আছে ইনশা-আল্লাহ",
    professionDetail: "কয়েকটা টিউশন করাই ক্লাস প্লে- সপ্তম।",
    marriageGuardianConsent: "জ্বী, আলহামদুলিল্লাহ।",
