...
export const districts = ["Dhaka","Chittagong","Sylhet","Rajshahi","Khulna","Barishal","Rangpur","Mymensingh","Comilla","Bogra","Coxs Bazar","Gazipur",
  {
    ...
    bloodGroup: "O+",
    nationality: "বাংলাদেশী",
    presentAddress: { district: "Rajshahi", division: "Rajshahi", area: "নওহাটা বড়গাছী" },
    permanentAddress: { district: "Rajshahi", division: "Rajshahi", area: "নওহাটা বড়গাছী" },
    grownUpIn: "গ্রামে",
    religion: "ইসলাম",
    madhab: "হানাফি",
    prayerRegularity: "নিয়মিত",
    hijabOrBeard: "বোরখা, হিজাব, নিকাব, হাত মোজা, পা মোজা",
    quranRecitation: "হ্যা আলহামদুলিল্লাহ",
    religiousQualification: "HSC (আলিয়া)",
    ...
    personalBooksRead: "ফেরা, প্রদীপ্ত কুটির, হিজাব আমার পরিচয়",
    personalFavScholars: "তারিক জামিল, শায়েখ আহমাদুল্লাহ, মিজানুর রহমান আজহারি",
    personalHobbies: "সাধারণ ঠান্ডা স্বভাবের মেয়ে। বই পড়তে পছন্দ করি। ফুল, প্রকৃতি এসব আমার ভীষন প্রিয়। গাছপালা অনেক পছন্দের।",
    professionDetail: "অনার্স ৩য় বর্ষে পড়ছি।",
    marriageGuardianConsent: "হ্যা",
    marriageJobAfter: "পার্সোনালি কোন ইচ্ছে নেই। তবে পারমিশন থাকতে হবে।",
    marriageStudyAfter: "জ্বি ইংশাআল্লাহ, গ্রাজুয়েশন শেষ করতে চাই।",
    marriageWhy: "অর্ধেক দ্বীন পূরনের জন্য, দুনিয়ার ফেতনাসমূহ থেকে বাঁচতে।",
    partnerPreferences: { ageRange: "25-30", height: "৫.৭ / এর বেশি", complexion: "শ্যামলা, উজ্জল শ্যামলা, ফর্সা", education: "স্নাতক", location: "নওগাঁর আশেপাশে, উত্তরবঙ্গে হলে ভালো হয়।", maritalStatus: "অবিবাহিত", profession: "হালাল ভালো চাকরি (ব্যাংক এবং পুলিশ ব্যতীত)", economicStatus: "সচ্ছল, মানানসই", qualities: "দ্বীনদার, চরিত্রবান, তাকওয়াবান, উত্তম আখলাকের অধিকারী।" },
    commitment1: "হ্যাঁ",
    commitment2: "হ্যাঁ",
    commitment3: "হ্যাঁ",
    guardianName: "মোঃ আব্দুল করিম",
