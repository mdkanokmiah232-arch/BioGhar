...
export default function RegisterPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    alert("রেজিস্ট্রেশন ফিচার শীঘ্রই আসছে ইনশাআল্লাহ!");
  };
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <header className="border-b border-gray-100 bg-white/80 backdrop-blur-md">
        <div className="mx-auto max-w-7xl px-4 py-4 flex items-center justify-between">
          ...
          <Link href="/login" className="text-sm text-gray-600 hover:text-emerald-700 transition">
            Login
          </Link>
        </div>
      </header>
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full rounded-lg border border-gray-300 px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 pr-10"
                    />
                    <button
                      type="button"
              ...
              <div className="flex items-start gap-2 text-sm text-gray-600">
                ...
                <span>
                  আমি{" "}
                  <a href="#" className="text-emerald-600 hover:text-emerald-700 font-medium">শর্তাবলী</a>{" "}
                  এবং{" "}
                  <a href="#" className="text-emerald-600 hover:text-emerald-700 font-medium">গোপনীয়তা নীতি</a>{" "}
                  পড়েছি এবং সম্মত।
                </span>
              </div>
