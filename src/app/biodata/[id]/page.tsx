          ...
          <div className="flex-1 space-y-4">
            ...
            <div className="bg-white rounded-xl border-2 border-emerald-600 overflow-hidden">
              ...
              <div className="p-5">
                ...
                <p className="text-center text-gray-600 text-sm mb-5">বায়োডাটা নং সহ WhatsApp-এ মেসেজ পাঠান।</p>
                <a href={`https://wa.me/8801354316246?text=${encodeURIComponent(`সালাম। BioGhar থেকে বায়োডাটা নং: ${biodata.biodataCode} দেখে মেসেজ দিচ্ছি।`)}`} target="_blank" rel="noopener noreferrer" className="w-full py-3 rounded-full text-white font-bold text-sm shadow-lg flex items-center justify-center gap-2 hover:opacity-90 transition" style={{ background: "linear-gradient(135deg, #25D366, #128C7E)" }}>
                ...
                <div className="mt-4 text-center text-xs text-gray-400">নম্বর: 01354-316246</div>
              </div>
            </div>
